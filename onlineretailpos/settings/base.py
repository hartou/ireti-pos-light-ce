...
MIDDLEWARE = [
    ...
    'onlineretailpos.middleware.PWASecurityMiddleware',  # PWA security headers
    'onlineretailpos.middleware.PaymentAuditMiddleware',  # Payment audit logging
